...
,like_review,get_review_user_data,edit_comment_review,delete_comment_review
...
urlpatterns=[
    ...
    path('comment-review/delete/<int:pk>',delete_comment_review, name="delete-review-comment"),
